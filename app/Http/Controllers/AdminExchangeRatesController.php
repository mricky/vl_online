<?php namespace App\Http\Controllers;
	...
	class AdminExchangeRatesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Mata Uang","name"=>"currency_id","join"=>"currencies,currency"];
			$this->col[] = ["label"=>"Mata Uang","name"=>"currency_to","join"=>"currencies,currency"];
			$this->col[] = ["label"=>"Tanggal","name"=>"date"];
			$this->col[] = ["label"=>"Kurs","name"=>"rate"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Mata Uang','name'=>'currency_id','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'currencies,currency'];
			$this->form[] = ['label'=>'Mata Uang','name'=>'currency_to','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'currencies,currency'];
			$this->form[] = ['label'=>'Tanggal','name'=>'date','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kurs','name'=>'rate','type'=>'number','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Currency To","name"=>"currency_to","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];

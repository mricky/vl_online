<?php namespace App\Http\Controllers;
	...
	class AdminSalesOrderDetailsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			#$this->col[] = ["label"=>"Product Location Id","name"=>"product_location_id","join"=>"product_location,id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Sales Order Id','name'=>'sales_order_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'sales_order,id'];
			...
			$this->form[] = ['label'=>'Product Location Id','name'=>'product_location_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'product_location,id'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Sales Order Id","name"=>"sales_order_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"sales_order,id"];
			...
			//$this->form[] = ["label"=>"Product Location Id","name"=>"product_location_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"product_location,id"];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
	        #$query->groupBy('customer_name','asc');
	    }
